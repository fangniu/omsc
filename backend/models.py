...
class DockerSwarm(models.Model):
    name = models.CharField(max_length=255, default='Cluster1')
    ip = models.GenericIPAddressField(null=True)
    port = models.IntegerField(null=True)
    socket = models.CharField(max_length=255, null=True)

    class Meta:
        db_table = 'docker_swarm'
    ...
    @property
    def base_url(self):
        return self.socket if self.socket else "%s:%s" % (self.ip, self.port)
